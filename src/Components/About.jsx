...
const About = () => {
            ...
            <div className='flex flex-wrap'>
                <div className='w-full lg:w-1/2'>
                    <div className='flex flex-col items-center lg:items-start px-24'>
                        < motion.h1  variants={container(0.1)}
                        initial='hidden' animate='visible'
                            className='pb-16 text-6xl  font-thin 
                        tracking-tight lg:mt-16 lg:text-6xl'>Aashritha Mitta</motion.h1>
   ...
   className='bg-gradient-to-r from-pink-300 via-slate-500 to-purple-700 bg-clip-text text-4xl tracking-tight text-transparent'
                ...
                <div className='flex justify-center'>
                    ...
                    transition={{duration:1, delay: 1.2}} src={profilePic} alt="profile" className="w-2/3 rounded-xl ml-24 mt-4 "/>
                </div>
                </div>
            </div>
